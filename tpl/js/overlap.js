(function($){
    ...
    var Carousel = function(con){
        ...
        this.settings = {
            width:1200,             //幻灯片的宽度
            height:353,             //幻灯片的高度
            postWidth:529,          //第一帧的宽度
            postHeight:353,         //第一帧的高度
            scale:0.8,
            speed:500,
    ...
    Carousel.prototype = {
        //设置上一张和下一张大小
        setDirect:function(){
            var prev = $("<div></div>").addClass("content-btn prev-btn").append($("<img/>").attr("src","tpl/images/left.png").addClass("btn-img"));
            this.con.prepend(prev);
            var next = $("<div></div>").addClass("content-btn next-btn").append($("<img/>").attr("src","tpl/images/right.png").addClass("btn-img"));
